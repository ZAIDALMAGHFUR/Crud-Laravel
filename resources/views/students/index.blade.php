                                ...
                                @foreach($students as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="/{{ $item->id }}" accept-charset="UTF-8" style="display:inline">
                                                @method('DELETE')
                                                @csrf
                                                <input type="submit" class="btn btn-danger btn-sm" title="Delete Student" value="Delete">
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
